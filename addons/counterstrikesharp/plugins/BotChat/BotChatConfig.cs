...
public sealed class BotChatFrequencyConfig
{
    ...
    public int StartMessageChancePercent { get; set; } = 60;

    [JsonPropertyName("HalftimeMessageChancePercent")]
    public int HalftimeMessageChancePercent { get; set; } = 35;

    [JsonPropertyName("MatchEndMessageChancePercent")]
    public int MatchEndMessageChancePercent { get; set; } = 60;

    [JsonPropertyName("KillReactionBaseChancePercent")]
    public int KillReactionBaseChancePercent { get; set; } = 3;

    [JsonPropertyName("KillReactionHeadshotBonusPercent")]
    public int KillReactionHeadshotBonusPercent { get; set; } = 4;

    [JsonPropertyName("KillReactionContextBonusPercent")]
    public int KillReactionContextBonusPercent { get; set; } = 10;
...
public sealed class BotChatTauntConfig
{
    ...
    public int DominantWinChancePercent { get; set; } = 5;
    ...
    public int HalftimeChancePercent { get; set; } = 10;

    [JsonPropertyName("AfterWinChancePercent")]
    public int AfterWinChancePercent { get; set; } = 5;
